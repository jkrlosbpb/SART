					...
					<div id="delete_empleado" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
					...
					<div class="modal-body">
					<div class="alert alert-danger">
					<p>Esta seguro de eliminar este Empleado?.</p>
					</div>
					</div>
					<div class="modal-footer">
					<button class="btn" data-dismiss="modal" aria-hidden="true"><i class="icon-remove icon-large"></i> Cerrar</button>
					<button name="delete_empleado" class="btn btn-danger"><i class="icon-check icon-large"></i> Si</button>
					</div>
					</div>
