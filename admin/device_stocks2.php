        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span10" id="content">
                     <div class="row-fluid">
					 <a href="add_Device.php" class="btn btn-info"  id="add" data-placement="right" title="Click para añadir dispositivo" ><i class="icon-plus-sign icon-large"></i> Agregar Dispositivo</a>
                 ...
                 ?>	 
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Inventario de Dispositivo(s) List</div>
                          <div class="muted pull-right">
								Total Dispositivo(s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
						  </div>
						  
                 <h4 id="sc">Lista de Dispositivos
 ...
 <br/>
	<div class="pull-left">
			  ...
			  <?php	
			   ...
			   OR dev_name = 'Tclado' OR dev_name = 'Tecado' OR dev_name = 'Tcado' OR dev_name = 'Tecad'OR dev_name = 'Tecao' OR dev_name = '(Teclado)'
			   OR dev_name = '(kbrd)'
			   ORDER BY stdevice.id DESC");
	           $count = mysql_num_rows($count_item);
               ?>					
				<li class="">
					<a href="Keyboard.php">Teclado&nbsp;<span class="label label-default"> <?php echo $count;?></span></a>
				</li>
...
<?php
		...
		$fecha_garantia = date("Y/m/d", strtotime("$fecha_compra +4 years"));
		$fecha_exp = date("Y/m/d", strtotime("$fecha_garantia - $fechaActual"));
		?>
