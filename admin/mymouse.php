...
<tr>
		<td><?php
			...
			<a rel="tooltip"  title="Actualizar Estado" id="t<?php echo $id; ?>" href="devlm_update_status.php<?php echo '?id='.$id; ?>&<?php echo 'stdev_id='.$get_id; ?>" class="btn btn-success"><i class="icon-upload-alt"></i> Estado</a></td>
		</tr>
