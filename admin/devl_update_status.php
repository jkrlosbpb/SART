	                        ...
	                        ?>	
		                        ...
		                        <div id="" class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left"><i class="icon-building"></i> Ubicación:&nbsp;<?php echo $location_row['stdev_location_name']; ?> Update Device Status</div>
										<div class="muted pull-right">
										<a id="return" data-placement="left" title="Click to Return" href="mydevice.php<?php echo '?stdev_id='.$stdev_id; ?>"><i class="icon-arrow-left"></i> Atrás</a>
										</div>
									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword"  placeholder="Device Status" >Estado de Dispositivo</label>
											<div class="controls">
