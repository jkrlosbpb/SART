     <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
                            ...
                            <li class="">
                            <a href="device_stocks.php"><i class="icon-chevron-right"></i><i class="icon-desktop"></i> Equipos en Inventario</a>
                            </li>
                            <li class="">
					  ...
					  <!------/.* manage SART user sidebar*------->	
						<li>						
                            ...
                            <li class="">
                            <a href="client_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Personal Técnico</a>
                            </li>
						    <li class="">
                            <a href="admin_user.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Usuario de Sistema</a>
                            </li>
                            <li class="">
                            <a href="empleados.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Gestionar Empleados</a>
                            </li>
						    </ul>
						</li>
					  ...
					  <!------/.* notification sidebar*------->
					    <li class="">
				           <a href="notification.php"><i class="icon-chevron-right"></i><i class="icon-globe"></i>&nbsp;Notificaciones
				           <?php if($not_read == '0'){
				           }else{ ?>
				           ...
				           <?php } ?>
			            		...
			            		<!------/.* System Log sidebar*------->	
						<li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs5"><i class="icon-chevron-right"></i><i class="icon-book"></i>&nbsp;Gestionar de Memos
							<div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs5" class="collapse">						
                            <li class="">
                            <a href=" "><i class="icon-chevron-right"></i><i class="icon-file"></i> Asignacion de Equipo</a>
                            </li>
						    <li class="">
                            <a href=" "><i class="icon-chevron-right"></i><i class="icon-file"></i> Retiro de Equipo</a>
                            </li>
                            <li class="">
                            <a href=" "><i class="icon-chevron-right"></i><i class="icon-file"></i> Prestamo de Equipo</a>
                            </li>
						    </ul>
						</li>
