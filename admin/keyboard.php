                 ...
                 ?>	
				   <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                             <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Lista de Teclados</div>
							 <div class="muted pull-right">
								No. de Teclados (s): <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                          </div>
						  
				<h4 id="sc">Lista de Teclados(s)
...
<!-----------------------------------Content------------------------------------>
		...
		LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		where dev_name = 'TECLADO' OR dev_name = 'teclado'
