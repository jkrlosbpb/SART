...
font-family:"Times New Roman","serif"'><img width=98%  id="Picture 1"
...
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
where dev_status = 'Nuevo' and stdev_id = '$get_id'		
order by date_deployment DESC")or die(mysql_error());
...
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
where dev_status = 'Usado' and stdev_id = '$get_id'		
order by date_deployment DESC")or die(mysql_error());
$count = mysql_num_rows($new);		                                               
?>   
  <td width=171 valign=top style='width:128.35pt;border-top:none;border-left:
...
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
where dev_status = 'Reparado' and stdev_id = '$get_id'		
order by date_deployment DESC")or die(mysql_error());
$count = mysql_num_rows($new);		                                               
?>
...
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
where dev_status = 'Dañado' and stdev_id = '$get_id'		
order by date_deployment DESC")or die(mysql_error());
$count = mysql_num_rows($new);		                                               
?>
...
?>
 <tr style='mso-yfti-irow:1;height:17.85pt'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><b style='mso-bidi-font-weight:normal'><u><span
  style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>Juan Sagastume
 ...
 <tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes'>
  ...
  mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>Tecnología
  Facilitator<o:p></o:p></span></p>
  </td>
  <td width=376 valign=top style='width:281.85pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span style='font-size:12.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>Propiedad
  Custodian<o:p></o:p></span></p>
  </td>
  <td width=376 valign=top style='width:281.85pt;padding:0in 5.4pt 0in 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span style='font-size:12.0pt;
  mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>VP por
  Operacion<o:p></o:p></span></p>
  </td>
 </tr>
</table>
...
<hr>
		<footer>
           <p>Todos los derechos reservados S.A.R.T Powered by BCIE ™ 2016</p>
        <footer>
</center>
</div>
</html>