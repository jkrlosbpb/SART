...
<?php 
mysql_query("update stdevice set dev_status='Reparado' where id = '$get_id'")or die(mysql_error());
mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Dispositivo Reparado $dev_name No. Inventario:$dev_serial')")or die(mysql_error());						
