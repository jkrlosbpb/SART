                ...
                <div class="span12" id="content">
                     <div class="row-fluid">
                        ...
                        <div class="block">
							...
							<h3></i><i class="icon-group"></i>&nbsp;Código Equipo Guerrero Desarrolladores</h3>
							<hr>
                                <div class="span3">
										<center>
                                ...
                                <div class="span3">
								        ...
								        <img id="developers" src="admin/images/NO-IMAGE-AVAILABLE.jpg" class="img-circle">
								        <hr>
										<p>Name: John dix Vallega</p>
										<p>Address: mabinay</p>
										<p>Email: gorqui129@hotmail.com</p>
                                ...
                                <div class="span3">
								        ...
								        <img id="developers" src="admin/images/NO-IMAGE-AVAILABLE.jpg" class="img-circle">
								        <hr>
										<p>Name: Jeffrey Daliva</p>
										<p>Address: Isio,Cauayan</p>
										<p>Email: .com</p>
